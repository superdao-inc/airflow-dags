...
test_source = DbtTestOperator(
    dag=dag,
    task_id='dbt_test_all_buf_ethereum_source',
    retries=1,
    select='source:buf_raw_data_ethereum',
...
for entity in ['blocks', 'transactions', 'traces']:
    ...
    entity_dbt_upload_into_raw_data = PythonOperator(
        ...
        op_kwargs={"table": entity, "blockchain": "polygon"},
        provide_context=True,
        trigger_rule=TriggerRule.ALL_SUCCESS,
    )
    ...
    if entity == 'traces':
        ...
        contracts_export_data = PythonOperator(
            dag=dag,
            task_id=task_to_pull_from,
            python_callable=export_data,
            op_kwargs={
        ...
        contracts_upload_data_to_clickhouse = PythonOperator(
            dag=dag,
        ...
        contracts_dbt_upload_into_raw_data = PythonOperator(
            dag=dag,
            task_id=f'replace_data_contracts',
            python_callable=replace_data_to_raw,
            op_kwargs={"table": "contracts", "blockchain": "polygon"},
            provide_context=True,
            trigger_rule=TriggerRule.ALL_SUCCESS,
        )
        ...
        (
            ...
            >> contracts_export_data
            >> contracts_upload_data_to_clickhouse
            >> test_source
            >> contracts_dbt_upload_into_raw_data
            >> finish
        )
        (
        ...
        for dep_entity in ['receipts', 'logs']:
            ...
            dep_dbt_upload_into_raw_data = PythonOperator(
                ...
                python_callable=replace_data_to_raw,
                op_kwargs={"table": dep_entity, "blockchain": "polygon"},
                provide_context=True,
                trigger_rule=TriggerRule.ALL_SUCCESS,
            )
            ...
            if dep_entity == 'logs':
                ...
                token_transfers_dbt_upload_into_raw_data = PythonOperator(
                    ...
                    python_callable=replace_data_to_raw,
                    op_kwargs={"table": "token_transfers", "blockchain": "polygon"},
                    provide_context=True,
                    trigger_rule=TriggerRule.ALL_SUCCESS,
                )
