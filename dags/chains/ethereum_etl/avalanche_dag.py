...
test_source = DbtTestOperator(
    dag=dag,
    task_id='dbt_test_all_buf_avalanche_source',
    retries=1,
    select='source:buf_raw_data_avalanche',
...
ethereum_etl_prepare_data = PythonOperator(
    ...
    op_kwargs={"blockchain": "avalanche", "batch_size": 50000},
...
for entity in ['blocks', 'transactions']:  # , 'traces']:
    ...
    entity_dbt_upload_into_raw_data = PythonOperator(
        ...
        op_kwargs={"table": entity, "blockchain": "avalanche"},
        provide_context=True,
        trigger_rule=TriggerRule.ALL_SUCCESS,
    )
    ...
    #                                                 task_id=task_to_pull_from,
    #                                                 python_callable=export_data,
    #                                                 op_kwargs={"table": "contracts", "task_to_pull_from": "ethereum_etl_prepare_data", "blockchain": "avalanche"},
    #                                                 provide_context=True,
    #                                                 executor_config=resource_config,
    #                                                 trigger_rule=TriggerRule.ALL_SUCCESS)
    ...
    #                                                     python_callable=upload_data_to_clickhouse,
    #                                                     op_kwargs={"table": "contracts", "task_to_pull_from": task_to_pull_from, "blockchain": "avalanche"},
    #                                                     provide_context=True,
    #                                                     trigger_rule=TriggerRule.ALL_SUCCESS)
    ...
    #                                                            python_callable=replace_data_to_raw,
    #                                                            op_kwargs={"table": "contracts", "blockchain": "avalanche"},
    #                                                            provide_context=True,
    #                                                            trigger_rule=TriggerRule.ALL_SUCCESS)
    ...
    if entity == 'transactions':
        for dep_entity in ['receipts', 'logs']:
            ...
            dep_dbt_upload_into_raw_data = PythonOperator(
                ...
                python_callable=replace_data_to_raw,
                op_kwargs={"table": dep_entity, "blockchain": "avalanche"},
                provide_context=True,
                trigger_rule=TriggerRule.ALL_SUCCESS,
            )
            ...
            if dep_entity == 'logs':
                ...
                token_transfers_dbt_upload_into_raw_data = PythonOperator(
                    ...
                    python_callable=replace_data_to_raw,
                    op_kwargs={"table": "token_transfers", "blockchain": "avalanche"},
                    provide_context=True,
                    trigger_rule=TriggerRule.ALL_SUCCESS,
                )
